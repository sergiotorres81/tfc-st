 ...
 *
 */
public class StubA implements IClaseA{
	 ...
	 * en el server.
	 * @param host Máquina dónde está el servidor
	 * @param port número de puerto dónde escucha
	...
	protected void connect(){
		try{
			...
			System.out.println("No se ha podido establecer la comunicación correctamente");			
			System.exit(1);
		}
	}
	/**
