...
/**
 * Esta interfaz exporta los métodos que deberán implementar los diferentes
 * clientes
 * 
...
public interface IClient {
     ...
     * 
     * @param host
     *            Máquina donde está el servidor
     * @param port
    ...
    /**
     * Envía un entero como byte al servidor al que está asociado el socket del
     * cliente
     * 
     * @param b
     *            entero que se va a enviar
     */
